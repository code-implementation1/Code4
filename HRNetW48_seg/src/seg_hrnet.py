        ...
        for i in range(len(self.fuse_layers)):
            ...
            for j in range(1, self.num_branches):
                if i == j:
                    ...
                    y = self.add(y, ops.interpolate(t, size=(height_output, width_output)))
                else:
...
class HighResolutionNet(nn.Cell):
    ...
    def construct(self, x):
        ...
        x2 = ops.interpolate(out2, size=(h, w))
        x3 = ops.interpolate(out3, size=(h, w))
        x4 = ops.interpolate(out4, size=(h, w))
