...
class MaskAssignerSampler(nn.Cell):
    ...
    def get_result(
            ...
            gt_seg_masks_i: ms.Tensor, pos_index: ms.Tensor,
            pos_valid_index: ms.Tensor, neg_index: ms.Tensor,
            neg_valid_index: ms.Tensor
        ...
        Args:
            ...
            gt_seg_masks_i (ms.Tensor): GT masks for current image.
        ...
        gt_seg_masks = ops.gather_nd(gt_seg_masks_i, pos_assigned_gt_index)
        ...
        if self.rcnn_mode:
            ...
            output = (
                ...
                pos_bboxes_, gt_seg_masks, pos_gt_labels, valid_pos_index
            )
        else:
    ...
    def construct(
            self, gt_bboxes_i: ms.Tensor, gt_seg_masks_i: ms.Tensor,
        ...
        Args:
            ...
            gt_seg_masks_i (ms.Tensor): GT masks. Tensor has a fixed shape
                (n, size, size) where n equals to self.assigner.num_gts.
        ...
        return self.get_result(
            ...
            gt_seg_masks_i=gt_seg_masks_i, pos_index=pos_index,
            pos_valid_index=pos_valid_index, neg_index=neg_index,
            neg_valid_index=neg_valid_index
        )
