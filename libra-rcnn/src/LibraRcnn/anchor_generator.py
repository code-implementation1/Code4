...
class AnchorGenerator(nn.Cell):
    ...
    Args:
        ...
        scales (Optional[List[int]]): Anchor scales for anchors in a single level.
    ...
    def gen_single_level_base_anchors(
        ...
        Args:
            ...
            ratios (ms.Tensor): The ratio between between the height
    ...
    def single_level_grid_priors(
        ...
        shift_xx = ms.ops.reshape(shift_xx, (feat_w * feat_h,))
        shift_yy = ms.ops.reshape(shift_yy, (feat_w * feat_h,))
        shifts = ms.ops.stack([shift_xx, shift_yy, shift_xx, shift_yy], axis=-1)
    ...
    def single_level_valid_flags(
        ...
        valid_xx = ms.ops.reshape(valid_xx, (feat_w * feat_h,))
        valid_yy = ms.ops.reshape(valid_yy, (feat_w * feat_h,))
