...
class DeltaXYWHBBoxCoder(nn.Cell):
    ...
    Example:
        ...
        >>> bboxes = coder.decode(rois, deltas, max_shape=(32, 32))
        >>> restored_deltas = coder.encode(rois, bboxes)
        >>> bboxes
        Tensor(shape=[4, 4], dtype=Float32, value=
        [[ 0.00000000e+00,  0.00000000e+00,  1.00000000e+00,  1.00000000e+00],
         [ 1.40859127e-01,  1.40859127e-01,  2.85914087e+00,  2.85914087e+00],
         [ 0.00000000e+00,  3.16060245e-01,  4.19452810e+00,  6.83939755e-01],
         [ 5.00000000e+00,  5.00000000e+00,  5.00000000e+00,  5.00000000e+00]])
        >>> restored_deltas
        Tensor(shape=[4, 4], dtype=Float32, value=
        [[ 0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  0.00000000e+00],
         [ 1.00000000e+00,  1.00000000e+00,  1.00000000e+00,  1.00000000e+00],
         [ 1.59726405e+00,  0.00000000e+00,  1.43378079e+00, -9.99999821e-01],
         [ 0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  0.00000000e+00]])
        >>> restored_bboxes = coder.decode(rois, restored_deltas)
        >>> restored_bboxes
        Tensor(shape=[4, 4], dtype=Float32, value=
        [[ 0.00000000e+00,  0.00000000e+00,  1.00000000e+00,  1.00000000e+00],
         [ 1.40859127e-01,  1.40859127e-01,  2.85914087e+00,  2.85914087e+00],
    ...
    def decode(
        ...
        Args:
            bboxes (ms.Tensor): Basic boxes. Shape (N, 4)
            pred_bboxes (ms.Tensor): Encoded offsets with respect to
                each roi. Has shape (N, 4). Note N = num_anchors * W * H
    ...
    def delta2bbox(
        ...
        Args:
            ...
            deltas (ms.Tensor): Encoded offsets relative to each roi.
                Has shape (N, 4). Note N = num_base_anchors * W * H, when
            ...
            add_ctr_clamp (bool): Whether to add center clamp. When set to
                True, the center of the prediction bounding box will be
                clamped to avoid being too far away from the center of the
                anchor. Only used by YOLOF. Default False.
            ctr_clamp (int): the maximum pixel shift to clamp. Only used by
                YOLOF. Default 32.
        Returns:
            ms.Tensor: Boxes with shape (N, 4), where 4
        ...
        if add_ctr_clamp:
            ...
            dwh = ops.clip_by_value(  # noqa
                dwh, clip_value_min=-max_ratio,  # noqa
                clip_value_max=max_ratio  # noqa
            )  # noqa
